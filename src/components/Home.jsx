    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
      {plans.map((plan, index) => (
        <motion.div
          ...
          whileHover={{
            scale: 1.02,
            boxShadow: theme === "light" ? "0 10px 25px rgba(0,0,0,0.1)" : "0 10px 25px rgba(168, 85, 247, 0.25)",
          }} // Adjusted shadow
        ...
        >
          ...
          <div className="text-center">
            <h4 className={`text-xs mb-1 ${theme === "light" ? "text-gray-600" : "text-muted-foreground"}`}>
              {plan.description}
            </h4>{" "}
            {/* Reduced */}
            ...
            <p className={`text-3xl font-extrabold mb-5 ${theme === "light" ? "text-gray-900" : "text-foreground"}`}>
              {plan.price}
            </p>{" "}
            {/* Reduced */}
            <ul className={`text-left mb-5 space-y-2 ${theme === "light" ? "text-gray-700" : "text-muted-foreground"}`}>
              {" "}
              {/* Reduced margin */}
            ...
            <motion.button
              ...
              className={`w-full px-5 py-2 rounded-lg font-semibold transition-all duration-200 text-base ${
...
const InteractiveVideoShowcase = () => {
  ...
  const sampleVideos = [
    {
      id: 1,
      title: "AI Avatar Demo 1",
      description: "Experience lifelike AI avatar generation",
      videoSrc: "/video1.mp4",
    },
    {
      id: 2,
      title: "AI Avatar Demo 2",
      description: "See natural expressions and movements",
      videoSrc: "/video2.mp4",
    },
    {
      id: 3,
  ...
  return (
    <section
      className={`relative -mt-20 pt-32 pb-16 px-4 ${theme === "light" ? "bg-gradient-to-br from-pink-50 to-purple-50" : "bg-gradient-to-br from-pink-900/20 to-purple-900/20"}`}
    >
      <div className="max-w-6xl mx-auto">
        ...
        >
          <h2 className={`text-3xl md:text-4xl lg:text-5xl font-bold mb-6 ${theme === "light" ? "text-gray-900" : ""}`}>
            <span className="bg-gradient-to-r from-pink-600 to-purple-600 bg-clip-text text-transparent">
              See AI Avatars in Action
            </span>
          </h2>
          <p
            className={`text-lg md:text-xl max-w-3xl mx-auto ${theme === "light" ? "text-gray-700" : "text-muted-foreground"}`}
          >
            Experience the power of our AI avatar technology
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          >
            <div
              className={`relative rounded-2xl overflow-hidden ${theme === "light" ? "bg-white shadow-2xl" : "bg-card border border-border"}`}
            >
              <div className="relative aspect-video">
                <video
                  ref={videoRef}
                  src={sampleVideos[activeVideo].videoSrc}
                    ...
                    <div className="flex items-center justify-between text-white">
                      <div className="flex items-center gap-4">
                        <motion.button
                          ...
                          className="p-3 rounded-full bg-pink-600/80 backdrop-blur-sm hover:bg-pink-600 transition-colors"
                        >
                      ...
                      <div className="text-right">
                        <h3 className="font-semibold text-xl">{sampleVideos[activeVideo].title}</h3>
                        <p className="text-sm text-white/80">{sampleVideos[activeVideo].description}</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                {!isPlaying && (
                  ...
                  >
                    <motion.button
                      ...
                      whileTap={{ scale: 0.9 }}
                      onClick={togglePlayPause}
                      className="p-6 rounded-full bg-pink-600 text-white shadow-2xl hover:bg-pink-700 transition-colors"
                    >
            ...
            {sampleVideos.map((video, index) => (
              <motion.div
                ...
                className={`cursor-pointer rounded-xl overflow-hidden transition-all duration-300 ${
                  activeVideo === index ? "ring-4 ring-pink-500 shadow-lg" : "hover:shadow-md"
                }`}
              >
                <div className="relative aspect-video">
                  <video src={video.videoSrc} className="w-full h-full object-cover" muted />
                  <div
                    className={`absolute inset-0 flex items-center justify-center ${
                      activeVideo === index ? "bg-pink-600/20" : "bg-black/40 hover:bg-black/20"
                    } transition-colors`}
                  >
                    {activeVideo === index ? (
                ...
                <div className={`p-3 ${theme === "light" ? "bg-white" : "bg-card"}`}>
                  <h4 className={`font-semibold text-sm ${theme === "light" ? "text-gray-900" : "text-foreground"}`}>
                    {video.title}
                  </h4>
                </div>
              </motion.div>
        ...
        >
          <motion.button
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            className="px-8 py-4 bg-gradient-to-r from-pink-600 to-purple-600 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300"
          >
...
const Home = () => {
  ...
  const detailedFeatures = [
    {
      ...
      description:
        "Deploy your AI avatar in interviews, meetings, and presentations. Maintain professional presence even when you're not physically available.",
      longDescription:
        "Transform how you handle professional commitments with AI-powered virtual presence. Your avatar can attend multiple meetings simultaneously, conduct interviews with natural conversation flow, and deliver presentations with your exact mannerisms and speaking style.",
    ...
    },
    {
      ...
      description:
        "Automatically record, transcribe, and summarize your conversations. Get intelligent insights delivered directly to your email.",
      longDescription:
        "Advanced AI processes your conversations in real-time, extracting key insights, action items, and important decisions. Receive comprehensive summaries with sentiment analysis and follow-up recommendations.",
    ...
    },
    {
      ...
      description:
        "Create perfect digital replicas with advanced voice synthesis and personality modeling. Your avatar thinks and speaks like you.",
      longDescription:
    ...
    },
    {
      ...
      description:
        "Build custom avatars for specific business tasks. Integrate seamlessly with webhooks, APIs, and existing workflows.",
      longDescription:
        "Enterprise-grade automation tools allow you to deploy specialized avatars for customer service, sales, training, and more. Full API access enables seamless integration with your existing business systems.",
  ...
  const testimonials = [
    {
      ...
      role: "CEO, TechStart",
      content:
        "This AI avatar technology has revolutionized our client meetings. I can be present in multiple meetings simultaneously.",
      rating: 5,
    },
    {
      ...
      content:
        "The voice cloning is incredibly accurate. Our customers can't tell the difference between me and my avatar.",
      rating: 5,
    },
    {
      name: "Emily Johnson",
      role: "HR Manager",
      content:
        "Perfect for conducting initial interviews. The conversation summaries save us hours of work every week.",
      rating: 5,
    },
  ]
  ...
  return (
    <div
      className={`min-h-screen ${theme === "light" ? "bg-white text-gray-900" : "bg-background"} overflow-x-hidden relative`}
    >
      <Navbar />
      ...
      >
        ...
        <div className="relative z-30 text-center px-4 max-w-6xl mx-auto">
          ...
          >
            Transform your presence with cutting-edge AI avatars. Clone your voice, replicate your personality, and be
            everywhere at once with our revolutionary platform.
          </motion.p>
          ...
          >
            <motion.button
              whileHover={{
                scale: 1.08,
                boxShadow:
                  theme === "light" ? "0 10px 25px rgba(168, 85, 247, 0.3)" : "0 10px 25px rgba(168, 85, 247, 0.6)",
              }}
              whileTap={{ scale: 0.95 }}
              onClick={() => {
                /* Implement direct signup or specific modal */
              }}
            ...
            <motion.button
              whileHover={{
                scale: 1.08,
                boxShadow: theme === "light" ? "0 10px 25px rgba(0, 0, 0, 0.15)" : "0 10px 25px rgba(0, 0, 0, 0.3)",
              }}
              whileTap={{ scale: 0.95 }}
              onClick={() => {
      ...
      <section
        id="about"
        ref={aboutRef}
        className={`py-14 md:py-20 px-4 ${theme === "light" ? "bg-white" : "bg-muted/30"}`}
      >
        {" "}
        {/* Reduced padding */}
        <div className="max-w-7xl mx-auto">
          ...
          >
            <h2
              className={`text-2xl md:text-3xl lg:text-4xl font-bold mb-4 ${theme === "light" ? "text-gray-900" : ""}`}
            >
              {" "}
              {/* Reduced */}
            ...
            <p
              className={`text-base md:text-lg max-w-4xl mx-auto ${theme === "light" ? "text-gray-700" : "text-muted-foreground"}`}
            >
              {" "}
              {/* Reduced */}
              We're pioneering the future of human-AI interaction, creating technology that doesn't replace humans but
              amplifies their presence and capabilities across digital spaces.
            </p>
          </motion.div>

          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-12 items-center mb-14">
            {" "}
            {/* Reduced gap/margin */}
            <motion.div
            ...
            >
              <CardContainer className="inter-var w-full">
                <CardBody
                  className={`relative group/card w-full h-auto rounded-xl p-5 border ${theme === "light" ? "bg-white hover:shadow-lg border-gray-200" : "dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1]"}`}
                >
                  {" "}
                  {/* Adjusted padding */}
            ...
            >
              <h3 className={`text-xl md:text-2xl font-bold ${theme === "light" ? "text-gray-900" : ""}`}>
                Redefining Digital Presence
              </h3>{" "}
              {/* Reduced */}
              <p className={`text-sm md:text-base ${theme === "light" ? "text-gray-700" : "text-muted-foreground"}`}>
                {" "}
                {/* Reduced */}
                Our mission is to break the barriers of physical presence. Whether you're a CEO managing global teams, a
                content creator reaching worldwide audiences, or a professional juggling multiple commitments, our AI
                avatars ensure you're always present where it matters most.
              </p>
      ...
      {detailedFeatures.map((feature, index) => (
        <section
          ...
          className={`relative py-14 md:py-20 px-4 ${index % 2 === 1 ? (theme === "light" ? "bg-white" : "bg-muted/30") : theme === "light" ? "bg-gray-50" : ""}`}
        >
          {" "}
          {/* Reduced padding */}
          ...
          <div className="max-w-7xl mx-auto relative z-10">
            <div
              className={`grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-12 items-center ${index % 2 === 1 ? "lg:grid-flow-col-dense" : ""}`}
            >
              {" "}
              {/* Reduced gap */}
              {/* Content */}
              ...
              >
                ...
                <div>
                  <h3 className={`text-2xl md:text-3xl font-bold mb-2 ${theme === "light" ? "text-gray-900" : ""}`}>
                    {feature.title}
                  </h3>{" "}
                  {/* Reduced */}
                  <p
                    className={`text-base md:text-lg text-purple-600 mb-3 ${theme === "light" ? "dark:text-purple-400" : "dark:text-purple-400"}`}
                  >
                    {feature.subtitle}
                  </p>{" "}
                  {/* Reduced */}
                  <p
                    className={`text-sm md:text-base mb-5 ${theme === "light" ? "text-gray-700" : "text-muted-foreground"}`}
                  >
                ...
                <motion.a
                  ...
                  whileHover={{
                    scale: 1.07,
                    boxShadow: `0 8px 15px ${feature.gradient.replace("from-", "").replace("to-", "")}30`,
                  }} // Adjusted shadow
                  whileTap={{ scale: 0.95 }}
      ...
      >
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p
              className={`text-base md:text-lg max-w-3xl mx-auto ${theme === "light" ? "text-gray-700" : "text-muted-foreground"}`}
            >
              {" "}
              {/* Reduced */}
                ...
                <CardContainer className="inter-var">
                  ...
                  >
                    ...
                    <CardItem translateZ="40">
                      <div>
                        <p className={`font-semibold text-sm ${theme === "light" ? "text-gray-900" : ""}`}>
                          {testimonials[currentTestimonialIndex].name}
                        </p>
                        <p className={`text-xs ${theme === "light" ? "text-gray-700" : "text-muted-foreground"}`}>
            ...
            {testimonials.map((_, index) => (
              <button
                ...
                className={`w-2.5 h-2.5 rounded-full transition-colors duration-200 ${
                  index === currentTestimonialIndex ? "bg-purple-600 scale-125" : "bg-gray-400/50 hover:bg-gray-500"
                }`}
      ...
      <section
        id="pricing"
        ref={pricingRef}
        className={`py-14 md:py-20 px-4 ${theme === "light" ? "bg-gray-50" : "bg-muted/30"}`}
      >
        {" "}
        {/* Reduced padding */}
        <div className="max-w-7xl mx-auto">
